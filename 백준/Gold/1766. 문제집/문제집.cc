...
list<int> Topological_Sort (struct GraphType& graph, priority_queue<int, vector<int>, greater<int>>& buffer);
priority_queue<int, vector<int>, greater<int>> Collect_In_degree (struct GraphType& graph);
...
int main (int argc, char* argv[]) {
	...
	priority_queue<int, vector<int>, greater<int>> buffer = Collect_In_degree (graph);
...
void Discount_In_degree (struct GraphType& graph, priority_queue<int, vector<int>, greater<int>>& buffer, int nodeNumber) {
